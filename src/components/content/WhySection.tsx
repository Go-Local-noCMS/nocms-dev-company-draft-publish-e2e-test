    ...
    <section className="bg-surface py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text mb-4" data-role="heading-3">{heading}</h2>
          ...
          {(reasons ?? []).map((reason) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-heading text-lg font-bold text-text mb-2" data-role="heading-4">{reason.title}</h3>
