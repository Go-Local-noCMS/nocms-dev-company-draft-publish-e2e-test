    ...
    <>
      ...
      <SectionWrapper bg="background">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text mb-6" data-role="heading">Our Mission</h2>
          <p className="text-lg text-muted leading-relaxed" data-role="subheading">
      ...
      <SectionWrapper bg="surface">
        <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text text-center mb-12" data-role="heading-2">Our Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.map((value) => (
            <div key={value.title} className="bg-background rounded-xl p-8 border border-text/5 hover:shadow-md transition-shadow">
              ...
              <h3 className="font-heading text-lg font-bold text-text mb-2" data-role="heading-3">{value.title}</h3>
      ...
      <SectionWrapper bg="background">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text text-center mb-10" data-role="heading-4">Our Story</h2>
      ...
      <SectionWrapper bg="background">
        <div className="text-center">
          <a
            href="/about/our-team"
            className="inline-flex items-center gap-2 text-primary font-semibold hover:gap-3 transition-all" data-role="text-4"
          >
